      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              href={siteConfig.APK_DOWNLOAD_URL}
          ...
          <div className="p-6 rounded-2xl bg-graphite-800 border border-graphite-700">
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li><strong className="text-gray-300">Versão:</strong> {siteConfig.apkVersion}</li>
              <li><strong className="text-gray-300">Tamanho:</strong> {siteConfig.apkSize}</li>
              <li><strong className="text-gray-300">Data:</strong> {siteConfig.apkReleaseDate}</li>
            </ul>
          </div>
