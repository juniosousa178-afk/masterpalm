...
// Cálculos do módulo financeiro — leitura opcional, sem efeito colateral.
...
class ResumoFinanceiroModulo {
  ...
  /// Saidas explicitas (nao inclui ajuste nem entrada extra).
  ...
  /// Impacto liquido do modulo no periodo: entradas - saidas + ajustes.
...
class FinanceiroService {
  ...
  static ResumoFinanceiroModulo resumoPeriodo({
    ...
    double despOp = 0, compra = 0, invest = 0, equipe = 0;
    var qtd = 0;
    ...
    return ResumoFinanceiroModulo(
      ...
      totalDespesasOperacionais: despOp,
  ...
  /// Lucro de vendas já calculado (ex.: fechamento) + impacto opcional do módulo.
  static double lucroEstimadoComModulo({
    required double lucroVendasTaxasCustos,
    required ResumoFinanceiroModulo modulo,
  }) {
    return lucroVendasTaxasCustos + modulo.impactoLiquidoModulo;
  }
}
